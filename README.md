...
- Deploy seguro: [docs/deploy.md](docs/deploy.md)
- Rollback seguro: [docs/rollback.md](docs/rollback.md)
- Smoke pós-deploy: [docs/smoke-tests.md](docs/smoke-tests.md)
- Incidentes: [docs/INCIDENT_PLAYBOOK.md](docs/INCIDENT_PLAYBOOK.md)
