...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .badge { display: inline-block; background: #fef3c7; color: #92400e; font-size: 12px; font-weight: 600; padding: 4px 10px; border-radius: 20px; margin-bottom: 24px; }
...
<body>
  <div class="wrapper">
    <div class="card">
      ...
      @if($customerName)
      <p>Olá, {{ $customerName }}! Este é um lembrete do seu agendamento nas próximas horas.</p>
      @else
      <p>Este é um lembrete do seu agendamento nas próximas horas.</p>
      @endif
      ...
      <p style="font-size:12px;color:#737373;">
        Este é um e-mail automático de lembrete. Não responda a esta mensagem.
      </p>
    </div>
