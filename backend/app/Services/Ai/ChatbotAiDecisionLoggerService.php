...
class ChatbotAiDecisionLoggerService
{
    ...
    public function logDecision(array $payload): AiChatbotDecisionLog
    {
        return AiChatbotDecisionLog::query()->create([
            ...
            'channel' => (string) ($payload['channel'] ?? AiChatbotDecisionLog::CHANNEL_WHATSAPP),
            'flow' => isset($payload['flow']) ? (string) $payload['flow'] : null,
            ...
            'handoff_area_id' => isset($payload['handoff_area_id']) ? (int) $payload['handoff_area_id'] : null,
            'handoff_area_name' => isset($payload['handoff_area_name']) ? (string) $payload['handoff_area_name'] : null,
            'handoff_type' => isset($payload['handoff_type']) ? (string) $payload['handoff_type'] : null,
