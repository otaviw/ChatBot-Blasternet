...
class StatefulBotService
{
    ...
    private function isMenuCommand(string $inputText, array $commands): bool
    {
        ...
        return in_array($compact, ['#', 'menu', 'inicio', 'iniciar', 'comecar', 'começar'], true)
            ...
            || str_contains($normalized, 'voltar inicio')
            || str_contains($normalized, 'voltar para o menu')
            || str_contains($normalized, 'voltar pro menu')
            || str_contains($normalized, 'voltar ao menu')
            || str_contains($normalized, 'voltar menu')
            || str_contains($normalized, 'ir para o inicio')
            || str_contains($normalized, 'ir pro inicio')
            || str_contains($normalized, 'ir ao inicio')
            || str_contains($normalized, 'ir para inicio')
            || str_contains($normalized, 'ir para o menu')
            || str_contains($normalized, 'ir pro menu')
            || str_contains($normalized, 'ir ao menu')
            || str_contains($normalized, 'ir para menu')
            || str_contains($normalized, 'ir par ao menu')
            || str_contains($normalized, 'me leva para o menu')
            || str_contains($normalized, 'me leva pro menu')
            || str_contains($normalized, 'me leve para o menu')
            || str_contains($normalized, 'me leve pro menu')
            || str_contains($normalized, 'quero ir para o menu')
            || str_contains($normalized, 'quero voltar para o menu')
            || str_contains($normalized, 'quero voltar pro menu')
            || str_contains($normalized, 'quero voltar para o inicio')
            || str_contains($normalized, 'quero voltar pro inicio')
            || str_contains($normalized, 'preciso ir para o menu')
            || str_contains($normalized, 'preciso ir pro menu')
            || str_contains($normalized, 'preciso ir par ao menu')
            || str_contains($normalized, 'tela inicial')
