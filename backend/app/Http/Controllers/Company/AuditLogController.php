...
class AuditLogController extends Controller
{
    ...
    private function humanizeAction(string $action): string
    {
        $known = [
            ...
            'company_meta_number.created' => 'Número Meta da empresa criado',
            'company_meta_number.updated' => 'Número Meta da empresa atualizado',
            'company_meta_number.activated' => 'Número Meta da empresa ativado',
            'company_meta_number.deactivated' => 'Número Meta da empresa desativado',
            'company_meta_number.primary_changed' => 'Número principal da empresa alterado',
            'company_meta_number.removed' => 'Número Meta da empresa removido',
            'contact.meta_number.changed' => 'Número padrão do contato alterado',
            'contact.meta_number.bulk_reassigned' => 'Número padrão de contatos reatribuído em lote',
            'conversation.send_number.selected' => 'Número de envio selecionado na conversa',
            'campaign.send_number.resolved' => 'Número de envio resolvido para campanha',
