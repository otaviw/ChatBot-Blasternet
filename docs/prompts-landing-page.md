# Prompts para Landing Page do ChatBot Blasternet

Use estes prompts com Cursor ou outra IA para gerar e refinar a landing page.

---

## Prompt 1: Criar a landing page
...
- Integrar na raiz do frontend (/) — a rota /entrar continua em /entrar
- Usar React (Vite), Tailwind ou o stack já existente no projeto
```

---

## Prompt 2: Refinar a landing page

```
Refine a landing page do Blasternet ChatBot com foco em:
...
2. Usabilidade (UX):
   ...
   - Garanta que o redirecionamento para /entrar funciona em todos os estados
   - Torne a mensagem de valor clara em poucos segundos de leitura

3. Consistência:
   - Use as mesmas fontes, cores e tokens do app (Layout, globals.css)
   - Mantenha tom profissional e limpo
```
